...
public class BoatManager : MonoBehaviour
{
    ...
    public SO_BoatParameters BoatPara;
    ...
    private void Start()
    {
        ...
        for (int i = 0; i < BoatPara.spawningCount; i++)
        {
    ...
    private GameObject GetRandomBoat()
    {
        ...
        {
            randomBoat = BoatPara.BoatHouseA;
        }
        else if (randomValue < 0.666f)
        {
            randomBoat = BoatPara.BoatHouseB;
        }
        else
        {
            randomBoat = BoatPara.BoatHouseC;
        }
